    ...
    $(function () {
      ...
      $('.timer').startTimer({		
        onComplete: function () {
          ...
          //$('.timer').replaceWith("#mojadda");
          //$ ( "#timercount").append("#mojadda") ;
          //$("#timercount").hide();
          $("div#timercount").empty();
          $("#mojadda").removeClass('d-none');
        }

      });
      $('#mojadda').click(function () {
		$("#mojadda").addClass('d-none');
        $('.timer').startTimer().reload();
